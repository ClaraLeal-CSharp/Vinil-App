...
data class VinilDiscs(
    ...
    val rimShadowColor: Color,
    val rimHighlightColor: Color,
    val grooveColor: Color,
    val grooveStrokeWidth: Dp,
    val grooveAlpha: Float,
    val grooveHighlightAlpha: Float,
    val grooveStartFraction: Float,
    val grooveEndFraction: Float,
    ...
    val centerHoleHighlightColor: Color,
