...
private fun defaultDiscs(colors: VinilColors): VinilDiscs = VinilDiscs(
    ...
    rimShadowColor = colors.background,
    rimHighlightColor = colors.surface,
    grooveColor = colors.outline,
    grooveStrokeWidth = 1.dp,
    grooveAlpha = 0.34f,
    grooveHighlightAlpha = 0.18f,
    grooveStartFraction = 0.18f,
    grooveEndFraction = 0.94f,
    shadowColor = Color(0xFF000000),
    shadowElevation = 22.dp,
    textureColor = colors.surface,
    textureAlpha = 0.13f,
    highlightColor = Color(0xFFFFFFFF),
    highlightAlpha = 0.22f,
    depthShadowAlpha = 0.30f,
    labelColor = colors.primary,
    centerHoleColor = colors.background,
    centerHoleHighlightColor = colors.surface,
